...
def add_department():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            #in case db add fails because department exists
...
@admin.route('/route/add',methods=['GET','POST'])
@login_required
def add_role():
    """
    Add a role
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            #in case of the role name already existing
...
def assign_employee(id):
    ...
    #prevent admins from being assigned a role or a department
